...
data_obese <- read_excel("C:/Users/alave/Downloads/Ob�sit�.xlsx", sheet = "DEP")
...
data_csp$`Part des cadres, professions intellect. sup�rieures` <- type.convert(data_csp$`Part des cadres, professions intellect. sup�rieures`, dec = ".")
data_csp$`Part des professions interm�d.` <- type.convert(data_csp$`Part des professions interm�d.`, dec = ".")
data_csp$`Part des employ�s` <- type.convert(data_csp$`Part des employ�s`, dec = ".")
